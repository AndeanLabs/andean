...
var (
	...
	fd_Price_value     protoreflect.FieldDescriptor
	fd_Price_timestamp protoreflect.FieldDescriptor
)

func init() {
	file_andean_itzel_price_proto_init()
	md_Price = File_andean_itzel_price_proto.Messages().ByName("Price")
	fd_Price_source = md_Price.Fields().ByName("source")
	fd_Price_value = md_Price.Fields().ByName("value")
...
func (x *Price) slowProtoReflect() protoreflect.Message {
	mi := &file_andean_itzel_price_proto_msgTypes[0]
...
func (x *fastReflection_Price) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "andean.itzel.Price.source":
		return x.Source != ""
	case "andean.itzel.Price.value":
		return x.Value != int32(0)
	case "andean.itzel.Price.timestamp":
		return x.Timestamp != int32(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: andean.itzel.Price"))
		}
		panic(fmt.Errorf("message andean.itzel.Price does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Price) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message andean.itzel.Price does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Price) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "andean.itzel.Price.source":
		panic(fmt.Errorf("field source of message andean.itzel.Price is not mutable"))
	case "andean.itzel.Price.value":
		panic(fmt.Errorf("field value of message andean.itzel.Price is not mutable"))
	case "andean.itzel.Price.timestamp":
		panic(fmt.Errorf("field timestamp of message andean.itzel.Price is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: andean.itzel.Price"))
		}
...
func (x *fastReflection_Price) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in andean.itzel.Price", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: andean/itzel/price.proto
...
func (*Price) Descriptor() ([]byte, []int) {
	return file_andean_itzel_price_proto_rawDescGZIP(), []int{0}
}
...
var File_andean_itzel_price_proto protoreflect.FileDescriptor

var file_andean_itzel_price_proto_rawDesc = []byte{
	0x0a, 0x18, 0x61, 0x6e, 0x64, 0x65, 0x61, 0x6e, 0x2f, 0x69, 0x74, 0x7a, 0x65, 0x6c, 0x2f, 0x70,
	0x72, 0x69, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x61, 0x6e, 0x64, 0x65,
	0x61, 0x6e, 0x2e, 0x69, 0x74, 0x7a, 0x65, 0x6c, 0x22, 0x53, 0x0a, 0x05, 0x50, 0x72, 0x69, 0x63,
	...
	0x28, 0x05, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x42, 0x88, 0x01,
	0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x6e, 0x64, 0x65, 0x61, 0x6e, 0x2e, 0x69, 0x74, 0x7a,
	0x65, 0x6c, 0x42, 0x0a, 0x50, 0x72, 0x69, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01,
...
var (
	file_andean_itzel_price_proto_rawDescOnce sync.Once
	file_andean_itzel_price_proto_rawDescData = file_andean_itzel_price_proto_rawDesc
)

func file_andean_itzel_price_proto_rawDescGZIP() []byte {
	file_andean_itzel_price_proto_rawDescOnce.Do(func() {
		file_andean_itzel_price_proto_rawDescData = protoimpl.X.CompressGZIP(file_andean_itzel_price_proto_rawDescData)
	})
	return file_andean_itzel_price_proto_rawDescData
}

var file_andean_itzel_price_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_andean_itzel_price_proto_goTypes = []interface{}{
	(*Price)(nil), // 0: andean.itzel.Price
}
var file_andean_itzel_price_proto_depIdxs = []int32{
...
func init() { file_andean_itzel_price_proto_init() }
func file_andean_itzel_price_proto_init() {
	if File_andean_itzel_price_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_andean_itzel_price_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Price); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_andean_itzel_price_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_andean_itzel_price_proto_goTypes,
		DependencyIndexes: file_andean_itzel_price_proto_depIdxs,
		MessageInfos:      file_andean_itzel_price_proto_msgTypes,
	}.Build()
	File_andean_itzel_price_proto = out.File
	file_andean_itzel_price_proto_rawDesc = nil
	file_andean_itzel_price_proto_goTypes = nil
	file_andean_itzel_price_proto_depIdxs = nil
}
