...
func init() {
	file_andean_itzel_genesis_proto_init()
...
func (x *GenesisState) slowProtoReflect() protoreflect.Message {
	mi := &file_andean_itzel_genesis_proto_msgTypes[0]
...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.PriceList) != 0 {
		value := protoreflect.ValueOfList(&_GenesisState_2_list{list: &x.PriceList})
		if !f(fd_GenesisState_priceList, value) {
			return
		}
	}
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "andean.itzel.GenesisState.params":
		return x.Params != nil
	...
	default:
		...
		panic(fmt.Errorf("message andean.itzel.GenesisState does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message andean.itzel.GenesisState does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in andean.itzel.GenesisState", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_GenesisState) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.PriceList) > 0 {
			for iNdEx := len(x.PriceList) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.PriceList[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field PriceList", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.PriceList = append(x.PriceList, &Price{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.PriceList[len(x.PriceList)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 3:
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return file_andean_itzel_genesis_proto_rawDescGZIP(), []int{0}
}
...
func (x *GenesisState) GetPriceList() []*Price {
	if x != nil {
		return x.PriceList
	}
	return nil
...
var file_andean_itzel_genesis_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x61, 0x6e, 0x64, 0x65, 0x61, 0x6e, 0x2f, 0x69, 0x74, 0x7a, 0x65, 0x6c, 0x2f, 0x67,
	0x65, 0x6e, 0x65, 0x73, 0x69, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x61, 0x6e,
	0x64, 0x65, 0x61, 0x6e, 0x2e, 0x69, 0x74, 0x7a, 0x65, 0x6c, 0x1a, 0x11, 0x61, 0x6d, 0x69, 0x6e,
...
var (
	file_andean_itzel_genesis_proto_rawDescOnce sync.Once
	file_andean_itzel_genesis_proto_rawDescData = file_andean_itzel_genesis_proto_rawDesc
)

func file_andean_itzel_genesis_proto_rawDescGZIP() []byte {
	file_andean_itzel_genesis_proto_rawDescOnce.Do(func() {
		file_andean_itzel_genesis_proto_rawDescData = protoimpl.X.CompressGZIP(file_andean_itzel_genesis_proto_rawDescData)
	})
	return file_andean_itzel_genesis_proto_rawDescData
}
...
func file_andean_itzel_genesis_proto_init() {
	if File_andean_itzel_genesis_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_andean_itzel_genesis_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_andean_itzel_genesis_proto_goTypes,
		DependencyIndexes: file_andean_itzel_genesis_proto_depIdxs,
		MessageInfos:      file_andean_itzel_genesis_proto_msgTypes,
	}.Build()
	File_andean_itzel_genesis_proto = out.File
	file_andean_itzel_genesis_proto_rawDesc = nil
	file_andean_itzel_genesis_proto_goTypes = nil
	file_andean_itzel_genesis_proto_depIdxs = nil
}
