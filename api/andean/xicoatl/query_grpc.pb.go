...
const (
	Query_Params_FullMethodName  = "/andean.xicoatl.Query/Params"
	Query_Pool_FullMethodName    = "/andean.xicoatl.Query/Pool"
	Query_PoolAll_FullMethodName = "/andean.xicoatl.Query/PoolAll"
)
